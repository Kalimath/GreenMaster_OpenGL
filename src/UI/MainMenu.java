...
public class MainMenu extends LargeMenu {
    ...
    public MainMenu(ToolController handler) {
        super(handler, loadTexture("res/img/UI/1.png"));

        int halfTileSize = TILESIZE/2;
        menuUI.addButton("Editor", "res/img/UI/EditorButton.png", (WIDTH-(256))-128, 512);
        menuUI.addButton("Quit", "res/img/UI/QuitButton.png", (WIDTH-(256))-128, ((2*64)+512)+halfTileSize);
    }
