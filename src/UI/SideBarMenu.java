...
public class SideBarMenu extends LargeMenu {
    public SideBarMenu(ToolController handler) {
        super(handler, loadTexture("res/img/UI/2.png"));

        int halfTileSize = TILESIZE/2;
        menuUI.addButton("Generate", "res/img/UI/ComposeButton.png", (WIDTH-(2*256))-32, halfTileSize);
        menuUI.addButton("MainMenu", "res/img/UI/MenuButton.png", (WIDTH-(256))-32, halfTileSize);
    }
