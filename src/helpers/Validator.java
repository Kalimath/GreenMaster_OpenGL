...
public class Validator {
    ...
    public static boolean IsValidPlace(@NotNull Placeable object, @NotNull GroundTile groundTile, @NotNull GardenGrid grid){
        boolean result = false;
        try{
            if(groundTile.getTileType().isPlantable && object instanceof Plant){
                result = true;
            }else if(groundTile.getTileType().equals(TileType.Water) && object instanceof Plant && ((Plant) object).getType().isPlantableInWater){
                result = true;
            }else if(groundTile.getTileType().isBuildable && object instanceof Construction){
                result = true;
            }else if (grid.getZoneFromPlaceable(object).getZone().contains(groundTile)){
                result = true;
            }else{
...
//    public static void ValidateAndDraw(@NotNull Placeable object, @NotNull GroundTile groundTile){
